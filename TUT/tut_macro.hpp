...
#define ENSURE_SAME_CONTENT( ... ) do { this->set_current_line( __LINE__ );  tut::ensure_same_content_real( __FILE__, __LINE__, UDL_STRINGIFY( # __VA_ARGS__ ), __VA_ARGS__ ); this->set_current_line( __LINE__ + 1 ); } while ( false )
