...
TUT_TEST_GROUP( tut_yaal_tools_hash_sha1, "yaal::tools::tools::hash::sha1" );
...
TUT_UNIT_TEST( "original suite <0> (empty)" )
	...
	ENSURE_EQUALS( "bad tools::hash", tools::hash::string( tools::hash::FUNCTION::SHA1, s ), HASH );
TUT_TEARDOWN()
...
TUT_UNIT_TEST( "from file" )
	...
	if ( setup._argc > 1 )
		cout << tools::hash::string( tools::hash::FUNCTION::SHA1, f ) << endl;
	else
		ENSURE_EQUALS( "bad tools::hash", tools::hash::string( tools::hash::FUNCTION::SHA1, f ), HASH );
TUT_TEARDOWN()
