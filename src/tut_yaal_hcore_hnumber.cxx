...
TUT_UNIT_TEST( "tangens<HNumber>()" )
	...
	ENSURE_EQUALS( "tangens( 1 ) failed", tangens( number::N1 ), HNumber( "1.557407724654902230506974807458360173087250772381520038383946605698861397151727289555099965202242984" ) );
TUT_TEARDOWN()
