...
TUT_UNIT_TEST( "grammar test" )
	...
	char const expected[][200] = {
		...
		"statement = ifStatement | whileStatement | foreachStatement | switchStatement | breakStatement | continueStatement | returnStatement | expressionList",
		"ifStatement = \"if\" >> '(' >> booleanExpression >> ')' >> scope >> -( \"else\" >> scope )",
		"whileStatement = \"while\" >> '(' >> booleanExpression >> ')' >> scope",
		"foreachStatement = \"foreach\" >> '(' >> variableIdentifier >> ':' >> expression >> ')' >> scope",
