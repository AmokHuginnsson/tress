...
TUT_UNIT_TEST( "grammar test" )
	...
	char const expected[][200] = {
		...
		"ifStatement = ( \"if\" >> '(' >> booleanExpression >> ')' >> scope >> *( \"else\" >> \"if\" >> '(' >> booleanExpression >> ')' >> scope ) >> -( \"else\" >> scope ) )",
		...
		"booleanValue = ( booleanAnd | booleanOr | booleanXor | booleanNot | booleanTest )",
		"variableSetter = regex( \"\\<[a-zA-Z_][a-zA-Z0-9_]*\\>\" )",
		...
		"booleanAnd = ( booleanAtom >> \"&&\" >> booleanAtom )",
		"booleanOr = ( booleanAtom >> \"||\" >> booleanAtom )",
		"booleanXor = ( booleanAtom >> \"^^\" >> booleanAtom )",
		"booleanNot = ( '!' >> booleanAtom )",
		"booleanTest = ( testEquals | testNotEquals | testLess | testGreater | testLessEq | testGreaterEq )",
		"multiplication = ( power >> *( '*/%' >> power ) )",
		"functionCallIdentifier = regex( \"\\<[a-zA-Z_][a-zA-Z0-9_]*\\>\" )",
		"argList = ( argument >> *( ',' >> argument ) )",
		"booleanAtom = ( true | false | ( '(' >> booleanExpression >> ')' ) | ( \"boolean\" >> '(' >> expression >> ')' ) )",
		"testEquals = ( anyExpression >> \"==\" >> anyExpression )",
		"testNotEquals = ( anyExpression >> \"!=\" >> anyExpression )",
		"testLess = ( expression >> '<' >> expression )",
		"testGreater = ( expression >> '>' >> expression )",
		"testLessEq = ( expression >> \"<=\" >> expression )",
		"testGreaterEq = ( expression >> \">=\" >> expression )",
