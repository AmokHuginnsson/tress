...
TUT_UNIT_TEST( 1, "a member (no args)" )
...
TUT_UNIT_TEST( 2, "a member (one int arg)" )
...
TUT_UNIT_TEST( 3, "a member (two int arg)" )
...
TUT_UNIT_TEST( 4, "a member (3 int arg)" )
...
TUT_UNIT_TEST( 5, "a member (4 int arg)" )
...
TUT_UNIT_TEST( 6, "a member (5 int arg)" )
...
TUT_UNIT_TEST( 7, "a member (6 int arg)" )
...
TUT_UNIT_TEST( 8, "a member (7 int arg)" )
...
TUT_UNIT_TEST( 9, "a member (8 int arg)" )
...
TUT_UNIT_TEST( 10, "a member (9 int arg)" )
...
TUT_UNIT_TEST( 11, "a member (10 int arg)" )
