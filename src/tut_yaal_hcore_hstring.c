...
---            `tress' 0.0.0 (c) 1978 by Marcin 'Amok' Konarski             ---
  ...
  tut_yaal_hcore_hstring.c - this file is integral part of `tress' project.
...
#include "header"
M_VCSID ( "$CVSHeader: tress/src/tut_yaal_hcore_hstring.c,v 1.5 2006/01/24 11:51:47 amok Exp $" )
