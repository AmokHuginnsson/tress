...
TUT_UNIT_TEST( "unnamed HHuginn grammar" )
	...
	char const huginnDesc[][640] = {
		...
		"L_ = ( ( B_ ^ \"...\" ) >> -( '=' >> C_ ) )",
		"M_ = ( B_ >> \"...\" )",
		"N_ = ( Q_ | R_ | S_ | T_ | U_ | V_ | W_ | X_ | Y_ | Z_ | AA_ )",
		"O_ = ( C_ >> *( ',' >> C_ ) )",
		"P_ = ( AB_ >> -( ( \"==\" | \"!=\" ) >> AB_ ) )",
		"Q_ = ( AC_ >> *( \"else\" >> AC_ ) >> -( \"else\" >> AA_ ) )",
		"R_ = ( \"while\" >> '(' >> C_ >> ')' >> AD_ )",
		"S_ = ( \"for\" >> '(' >> E_ >> ':' >> C_ >> ')' >> AD_ )",
		"T_ = ( \"switch\" >> '(' >> C_ >> ')' >> '{' >> +( \"case\" >> '(' >> integer >> ')' >> ':' >> AA_ ) >> '}' )",
		"U_ = ( \"try\" >> AA_ >> +( \"catch\" >> '(' >> B_ >> E_ >> ')' >> AA_ ) )",
		"V_ = ( \"throw\" >> C_ >> ';' )",
		"W_ = ( \"break\" >> ';' )",
		"X_ = ( \"continue\" >> ';' )",
		"Y_ = ( \"return\" >> '(' >> C_ >> ')' >> ';' )",
		...
		"AB_ = ( AE_ >> -( ( \"<=\" | \">=\" | \"<\" | \">\" ) >> AE_ ) )",
		"AC_ = ( \"if\" >> '(' >> C_ >> ')' >> AA_ )",
		"AD_ = ( '{' >> *( Q_ | R_ | S_ | T_ | U_ | V_ | W_ | X_ | Y_ | Z_ | AA_ ) >> '}' )",
		"AE_ = ( AF_ >> *( '+' >> AF_ ) )",
		"AF_ = ( AG_ >> *( '*' >> AG_ ) )",
		"AG_ = ( ( '-' >> AG_ ) | ( ( ( '-' >> AH_ ) | AH_ ) >> *( '^' >> AG_ ) ) )",
		"AH_ = ( ( ( '|' >> C_ >> '|' ) | ( ( '(' >> C_ >> ')' ) >> -( J_ >> AI_ ) ) | real | integer"
			" | ( ( ( '$' >> real ) | character_literal ) >> -( J_ >> I_ ) ) | ( ( ( '(' >> -O_ >> -',' >> ')' )"
			" | ( '[' >> -O_ >> ']' ) | ( '{' >> -( AJ_ >> *( ',' >> AJ_ ) ) >> '}' ) | ( '[' >> -( AJ_ >> *( ',' >> AJ_ ) ) >> ']' )"
			" | string_literal ) >> -( ( H_ | J_ ) >> AI_ ) ) | ( ( '{' >> C_ >> *( ',' >> C_ ) >> '}' ) >> -( J_ >> AI_ ) )"
			" | \"none\" | \"true\" | \"false\" | ( B_ >> AI_ )"
			" | ( ( '@' >> -( '[' >> B_ >> *( ',' >> B_ ) >> ']' ) >> G_ ) >> -( I_ >> AI_ ) ) ) >> -( ( '!' & \"==\" )"
			" | ( '!' ^ '=' ) ) )",
		"AI_ = *( H_ | I_ | J_ )",
		"AJ_ = ( C_ >> ':' >> C_ )"
