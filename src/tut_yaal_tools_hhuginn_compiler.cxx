...
/*  80 */ { 10, 2, 2,  "*anonymous stream*:2:2: Symbol `x' is not defined in this context (did you mean `set'?)." },
...
/*  93 */ { 9, 2, 1,   "*anonymous stream*:2:1: Variable `x' is never used (did you mean `set'?)." },
/*  94 */ { 6, 1, 7,   "*anonymous stream*:1:7: Class `C' is never used (did you mean `set'?)." },
