...
---            `tress' 0.0.0 (c) 1978 by Marcin 'Amok' Konarski             ---
	...
	tut_yaal_tools_hash_sha512.cxx - this file is integral part of `tress' project.
...
TUT_TEST_GROUP( tut_yaal_tools_hash_sha512, "yaal::tools::hash::sha512" );
...
TUT_UNIT_TEST( "original suite <0> (empty)" )
	...
	ENSURE_EQUALS( "bad hash", hash::sha512( s ), HASH );
TUT_TEARDOWN()
...
TUT_UNIT_TEST( "from file" )
	...
	if ( setup._argc > 1 ) {
		cout << hash::sha512( f ) << endl;
	} else {
		ENSURE_EQUALS( "bad hash", hash::sha512( f ), HASH );
	}
TUT_TEARDOWN()
