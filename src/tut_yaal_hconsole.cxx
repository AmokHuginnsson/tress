...
TUT_UNIT_TEST( "mouse" )
	play(
		"mouse", {
			KEY<'l'>::ctrl,
			KEY_CODES::MOUSE, 2, 4, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 6, 5, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 6, 5, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 2, 5, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 15, 2, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 15, 2, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 30, 10, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 30, 10, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 70, 13, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 70, 13, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 62, 18, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 62, 18, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 24, 10, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 24, 10, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 2, 11, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 2, 11, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 50, 13, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 50, 13, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 48, 17, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 48, 17, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 5, 5, MOUSE_BUTTON1,
			KEY_CODES::MOUSE, 5, 5, MOUSE_WHEEL_DOWN,
			KEY_CODES::MOUSE, 5, 5, MOUSE_WHEEL_UP,
			KEY<'q'>::command, KEY<'x'>::command
		}
	);
TUT_TEARDOWN()
...
TUT_UNIT_TEST( "XML Window" )
	play(
		"XML Window", {
			KEY_CODES::DOWN, KEY_CODES::RIGHT, KEY_CODES::DOWN, KEY_CODES::DOWN, '\r',
			KEY<'q'>::command, KEY<'x'>::command
		}
	);
TUT_TEARDOWN()
