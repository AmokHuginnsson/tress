...
struct tut_yaal_hcore_hhashmultimap : public simple_mock<tut_yaal_hcore_hhashmultimap> {
	...
	typedef HHashMultiMap<int, int, hash<int>, HMultiContainerStorage::HPacked> mmp_t;
	typedef HHashMultiMap<int, int, hash<int>, HMultiContainerStorage::HTransparent> mmt_t;
};
