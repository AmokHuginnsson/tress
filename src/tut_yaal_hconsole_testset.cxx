...
---           booker 0.0.0 (c) 1978 by Marcin 'Amok' Konarski            ---
  ...
  tut_yaal_hconsole_testset.cxx - this file is integral part of booker project.
...
HTestSet::HTestSet( HDataBase::ptr_t dataBase_ )
	...
	, _vInt()
	, _vReal()
	, _vDate( HTime::TZ::LOCAL, _iso8601DateFormat_ )
	, _vTime( HTime::TZ::LOCAL, _iso8601TimeFormat_ )
	, _vDatetime( HTime::TZ::LOCAL, _iso8601DateTimeFormat_ ) {
	M_PROLOG
