...
/*  44 */ { 46, 3, 13,   "*tress*:3:13: NumberSetStatistics.constructor() argument must be one of {a `tuple', a `list', a `deque', a `set', an `order'}, not an `integer'." },
...
/*  48 */ { 46, 3, 13,   "*tress*:3:13: NumberSetStatistics.constructor() argument must be one of {a `tuple', a `list', a `deque', a `set', an `order'}, not a `lookup'." },
/*  49 */ { 46, 3, 13,   "*tress*:3:13: NumberSetStatistics.constructor() argument must be one of {a `tuple', a `list', a `deque', a `set', an `order'}, not a `dict'." },
...
/*  56 */ { 60, 6, 6,    "*tress*:6:6: `Base' does not have `bar' member (did you mean `add'?)." },
