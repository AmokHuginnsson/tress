...
/*  25 */ { 46, 5, 11,   "*tress*:5:11: `For` source is not an iterable." },
/*  25 */ { 79, 8, 11,   "*tress*:8:11: User defined `iterable`, a `L`, returned invalid iterator object - an `integer`." },
...
/*  31 */ { 423, 34, 11, "*tress*:34:11: User defined `iterator`, a `LI`, returned an invalid type an `integer` instead of a `boolean` from supplied `is_valid` method." },
