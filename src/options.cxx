...
int handle_program_options( int argc_, char** argv_ ) {
	...
	po( "log_path", program_options_helper::option_value( setup._logPath ), HProgramOptionsHandler::OOption::TYPE::REQUIRED, "path pointing to file for application logs", "path" )
		...
		( "gtest_color", program_options_helper::option_value( setup._color ), HProgramOptionsHandler::OOption::TYPE::OPTIONAL, "google reporter option (converted to -C)" )
		...
		( "gtest_list_tests", program_options_helper::option_value( setup._listGroups ), HProgramOptionsHandler::OOption::TYPE::NONE, "google runner option (converted to -L)" )
